...
public actor ModelContainer {
    ...
    public func perform<R>(_ action: @Sendable (any SpeechToTextModel, Tokenizer) throws -> R) rethrows
        -> R
    {
    ...
    public func perform<V, R>(
        values: V, _ action: @Sendable (any SpeechToTextModel, Tokenizer, V) throws -> R
    ) rethrows -> R {
