...
/// Context of types that work together to provide a ``SpeechToTextModel``.
///
...
/// - ``SpeechToTextModel`` -- the model itself, see ``generate(input:parameters:context:didGenerate:)``
...
public struct ModelContext {
    ...
    public let model: any SpeechToTextModel
    public let processor: any UserInputProcessor
    public let tokenizer: Tokenizer

    public init(
        configuration: ModelConfiguration, model: any SpeechToTextModel,
