...
/// calls ``SpeechToTextModel/sanitize(weights:)``, applies optional quantization, and
/// updates the model with the weights.
public func loadWeights(
    modelDirectory: URL, model: SpeechToTextModel, quantization: BaseConfiguration.Quantization? = nil
) throws {
    // load the weights
