...
public class WhisperModel: Module, SpeechToTextModel {
    public func prepare(_ input: STTMInput) throws -> PrepareResult {
...
//    @ModuleInfo(key: "lm_head") var lmHead: Linear?
    ...
    public init(_: WhisperConfiguration) {
...
//        }
    ...
    public func callAsFunction(_: MLXArray, cache _: [KVCache]?) -> MLXArray {
        fatalError("unimplemented")
