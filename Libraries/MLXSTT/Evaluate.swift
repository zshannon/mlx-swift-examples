...
//
    ...
    ///   - parameters: the generation parameters
    public init(
        input: STTMInput, model: any SpeechToTextModel,
        parameters: GenerateParameters
    ) throws {
//        self.model = model
//        self.y = input.text
...
//    }
//
    mutating func prepare(input: STTMInput, windowSize: Int? = nil) throws {
//        processor?.prompt("input.text.tokens")
        fatalError("TODO")
...
//    public let inputText: STTMInput.Text
...
//    }
    ...
    public func summary() -> String {
        """
        Prompt:     \(0) tokens, \(promptTokensPerSecond.formatted()) tokens/s
...
public func generate(
    input: STTMInput, parameters: GenerateParameters, context: ModelContext,
...
/// - Returns: the generated output
public func generate(
    input: STTMInput, context: ModelContext,
